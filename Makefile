...
# SOURCES= disk_emu.c sfs_api.c sfs_mytest.c sfs_api.h bitmap.c
# SOURCES= disk_emu.c sfs_api.c sfs_mytest2.c sfs_api.h bitmap.c


OBJECTS=$(SOURCES:.c=.o)
EXECUTABLE= 260625062_DISHI_ZHU
